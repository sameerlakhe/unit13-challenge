    ...
    if age is not None:
        ...
        if age < 1 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You should be between 1 and 65 years old to use this service, "
...
def recommend_portfolio(intent_request):
    ...
    initial_recommendation  = recommend_by_risk_preference(risk_level)
...
def recommend_by_risk_preference(risk_level):
    initial_recommendation ="Sorry,No recommendation"
